# -*- coding: utf-8 -*-
"""
Created on Sat Jun 10 15:16:54 2023
...
# Exclude variables from the selectbox options
excluded_variables = ["BMI", "Sleep Time", "Physical Health", "Mental Health Score"]
variables = [col for col in df.columns if col not in excluded_variables]

# Add a selectbox to the sidebar to allow the user to choose a variable
variable = st.sidebar.selectbox("Select a variable", variables)
